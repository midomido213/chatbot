...
function ishiDb(targetScore, actualScore, satisfaction, reflection){
  var date = new Date(2020, 9, 22, 0, 0, 0, 0); // 月は0~11
...
function question(){
  botui.message.add({
    delay:1000,
    loading:true,
    content:'今回の事前テストの目標点数は何点だったか選択してください。（ない場合は10点を選択してください。）'
  }).then(function(){
    log = '今回の事前テストの目標点数は何点だったか選択してください。（ない場合は10点を選択してください。）';
    addBot(log);
    botui.action.select({
      action:{
        placeholder:'点数を選んでね',
...
function exam1(){
  botui.message.add({
    delay:200,
    loading:true,
    content:'今回の事前テストの点数を選択してください。（ない場合は10点を選択してください。）'
  }).then(function(){
    log = '今回の事前テストの点数を選択してください。（ない場合は10点を選択してください。）';
    addBot(log);
    botui.action.select({
      action:{
        placeholder:'点数を選んでね',
...
function search(message){
  if((message.indexOf('場合の数') != -1)){
    botui.message.add({
      ...
      botui.message.add({
        ...
        botui.message.add({
          ...
          log += 'https://www.youtube.com/embed/264GkHFM27Y<br>';
          botui.message.add({
            delay:1000,
            loading:true,
    ...
    botui.message.add({
      ...
      log = '順列の基本(場合の数)に関する補足説明動画が見つかりました！<br>';
      botui.message.add({
        delay:1000,
        loading:true,
        content:'動画を見ることで理解できるかもしれないので，見てみてください！'
        ...
        botui.message.add({
          ...
          log += 'https://www.youtube.com/embed/lcQ0CeQsnl8<br>';
          botui.message.add({
            delay:1000,
            loading:true,
            content:'動画を見終わったらボタンを押してください．'
    ...
    botui.message.add({
      ...
      log = 'nPr(順列の総数)に関する補足説明動画が見つかりました！<br>';
      botui.message.add({
        delay:1000,
        loading:true,
        content:'動画を見ることで理解できるかもしれないので，見てみてください！'
        ...
        botui.message.add({
          ...
          log += 'https://www.youtube.com/embed/N24cC9UmKBA<br>';
          botui.message.add({
            delay:1000,
            loading:true,
            content:'動画を見終わったらボタンを押してください．'
  ...
  }else if(message.indexOf('階乗') != -1){
    botui.message.add({
      delay:1000,
      loading:true,
      content:'nPr(順列の総数・階乗)に関する補足説明動画が見つかりました！'
    }).then(function(){
      log = 'nPr(順列の総数・階乗)に関する補足説明動画が見つかりました！<br>';
      botui.message.add({
        delay:1000,
        loading:true,
        content:'動画を見ることで理解できるかもしれないので，見てみてください！'
        ...
        botui.message.add({
          ...
          log += 'https://www.youtube.com/embed/qKp-TpB0x6s<br>';
          botui.message.add({
            delay:1000,
            loading:true,
            content:'動画を見終わったらボタンを押してください．'
...
function ishi_reflection2(executing){
  botui.message.add({
    delay:500,
    loading:true,
    content:'あなたの第４回授業の計画実施率は' + executing + '%でした。'
  }).then(function(){
    log = 'あなたの第４回授業の計画実施率は' + executing + '%でした。';
    addBot(log);
    botui.message.add({
      delay:500,
      loading:true,
