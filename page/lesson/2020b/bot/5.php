...
<html>
  ...
  <body>
    ...
    <div class="hero is-info is-bold">
      <div class="hero-body">
        <div class="container">
          <h1 class="title">第５回 学習振り返りページ</h1>
          <h2 class="subtitle">＠２０２０年度情報基礎数学B</h2>
        </div>
      </div>
    </div>
           ...
           <div class="media-content">
              <div class="content">
                <div class="botui-app-container" id="chat-app">
                  ...
                  $classDate = new DateTime('2020-10-29 00:00:00', new DateTimeZone('Asia/Tokyo'));
                  ...
                  try{
                    ...
                    if($check > 0){
                      ...
                      header("refresh:5;url=https://tkg-lab.tk/chatbot/page/lesson/2020b/history/");
                    }else{
                      echo '<bot-ui></bot-ui>';
                    }
