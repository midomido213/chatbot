...
try{
  ...
  $stmt = $pdo->prepare('INSERT INTO exam2020c (name, exam1, exam2, exam3, exam4, exam5, reExam1, reExam2, reExam3, reExam4, reExam5) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)');
  $stmt->execute([$name, $exam1, $exam2, $exam3, $exam4, $exam5, $reExam1, $reExam2, $reExam3, $reExam4, $reExam5]);
