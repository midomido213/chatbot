...
function q1(){
  botui.message.add({
    delay:1000,
    loading:true,
    content:'今回の予習は、背理法・数学的帰納法のプリントでした。'
  }).then(function(){
    log = '今回の予習は、背理法・数学的帰納法のプリントでした。';
    sendlog(log);
    botui.message.add({
      delay:1000,
      loading:true,
      content:'全ての問題を事前に予習してきましたか？'
    }).then(function(){
      log = '全ての問題を事前に予習してきましたか？';
      sendlog(log);
      // ボタン表示
      return botui.action.button({
        autoHide:false,
...
function q2(){
  botui.message.add({
    delay:1000,
    loading:true,
    content:'今回の予習で分からない箇所はありましたか？'
  }).then(function(){
    log = '今回の予習で分からない箇所はありましたか？';
    sendlog(log);
    // ボタン表示
    return botui.action.button({
      autoHIde:false,
...
function q3(){
  botui.message.add({
    delay:1000,
    loading:true,
    content:'分からなかった箇所はどんな所でしたか？'
  }).then(function(){
    log = '分からなかった箇所はどんな所でしたか？';
    sendlog(log);
    botui.message.add({
      delay:1000,
      loading:true,
...
function end(){
  botui.message.add({
    ...
    botui.message.add({
      delay:1000,
      loading:true,
      content:'入力内容は，今後の補助教材づくりに活かしていきます！'
    }).then(function(){
      log = '入力内容は，今後の補助教材づくりに活かしていきます！';
      sendlog(log);
      botui.message.add({
        delay:1000,
        loading:true,
