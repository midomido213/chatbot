...
function q1(){
  botui.message.add({
    delay:1000,
    loading:true,
    content:'今回の予習内容は、作問演習でした。'
  }).then(function(){
    log = '今回の予習内容は、作問演習でした。';
    sendlog(log);
    botui.message.add({
      delay:1000,
      loading:true,
      content:'事前に問題を作成してきましたか？'
    }).then(function(){
      log = '事前に問題を作成してきましたか？';
      sendlog(log);
      // ボタン表示
...
function q2(){
  botui.message.add({
    delay:1000,
    loading:true,
    content:'これまで学習してきた平面ベクトル、空間ベクトルの中で、まだ理解ができていないと感じる箇所はありますか？'
  }).then(function(){
    log = 'これまで学習してきた平面ベクトル、空間ベクトルの中で、まだ理解ができていないと感じる箇所はありますか？';
    sendlog(log);
    // ボタン表示
    return botui.action.button({
      autoHIde:false,
...
function q3(){
  botui.message.add({
    ...
    log = '理解が足りていないと自分が感じている箇所はどんな所ですか？';
    sendlog(log);
    botui.message.add({
      delay:1000,
      loading:true,
...
function end(){
  botui.message.add({
    ...
    botui.message.add({
      delay:1000,
      loading:true,
      content:'今回はシステム利用アンケートも実施します。'
    }).then(function(){
        log = '今回はシステム利用アンケートも実施します。';
        sendlog(log);
        botui.message.add({
          delay:1000,
          loading:true,
          content:'回答よろしくお願いします！'
      }).then(function(){
        log = '回答よろしくお願いします！'
        sendlog(log);
        botui.message.add({
          delay:1000,
          loading:true,
          content:'また、次回の予習からシステムの大幅な改善を予定しています。'
        }).then(function(){
          log = 'また、次回の予習からシステムの大幅な改善を予定しています。'
          sendlog(log);
          botui.message.add({
            delay:1000,
            loading:true,
            content:'次回からもよろしくお願いします！'
          }).then(function(){
            log = '次回からもよろしくお願いします！'
            sendlog(log);
            botui.message.add({
              delay:1000,
              loading:true,
              content:'[ココを押して振り返り終了](http://153.126.193.128/chatbot/page/lesson/2019c/)'
            });
          });
        });
      });
...
function quit(){
  botui.message.add({
    ...
    botui.message.add({
      delay:1000,
      loading:true,
      content:'[ここを押して前のページに戻る](http://153.126.193.128/chatbot/page/lesson/2019c/)'
    });
  });
}
